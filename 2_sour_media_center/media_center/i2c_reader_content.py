#!/usr/bin/env python3
"""
I2C Reader für Arduino 1 (Inhaltswahl) - Interrupt-Modus

Liest Schalterposition (0-10) und Potentiometer (0-1023) vom Arduino 1
über I2C, wenn der Arduino einen Interrupt sendet (bei Änderungen).

Wird von radio_player.py, youtube_player.py und audiobook_player.py
verwendet, um Drehschalter (Station/Kanal/Datei) und Poti (Lautstärke)
zu lesen.

Hardware:
  - Arduino 1 I2C Adresse: 0x08
  - Interrupt-Pin: GPIO 16
  - I2C: SDA (GPIO 2), SCL (GPIO 3)

Umbenannt von: i2c_reader_simple.py → i2c_reader_content.py
...
I2C_BUS = 1
ARDUINO_ADDR = 0x08
INTERRUPT_PIN = 16  # GPIO 16 (Pin 36)
