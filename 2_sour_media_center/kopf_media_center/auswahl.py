...
try:
    from kopf_media_center.i2c_reader_program import SimpleI2CReader
    I2C_AVAILABLE = True
...
PROGRAMS = {
    0: ("Radio",    "kopf_media_center.radio_player"),
    1: ("YouTube",  "kopf_media_center.youtube_player"),
    2: ("Hörbuch",  "kopf_media_center.audiobook_player"),
    # Positionen 3-10 können später ergänzt werden:
    # 3: ("Podcast", "kopf_media_center.podcast_player"),
}
